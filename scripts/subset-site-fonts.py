...
def main() -> int:
    ...
    jobs = [
        (SRC_ROOT / 'glow/GlowSansTC-Normal-Regular.otf', OUT / 'glow-sans-tc/GlowSansTC-Regular.woff2'),
        (SRC_ROOT / 'glow/GlowSansTC-Normal-Medium.otf', OUT / 'glow-sans-tc/GlowSansTC-Medium.woff2'),
        (SRC_ROOT / 'glow/GlowSansTC-Normal-Bold.otf', OUT / 'glow-sans-tc/GlowSansTC-Bold.woff2'),
