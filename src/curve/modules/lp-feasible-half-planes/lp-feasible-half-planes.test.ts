...
import { lpFeasibleHalfPlanesModule } from './index';

// TODO: 替換佔位幾何後，補上此作品核心數學性質的斷言。
describe('lp-feasible-half-planes module', () => {
  it('預設參數採樣非空且落在設計舞台內', () => {
    const out = lpFeasibleHalfPlanesModule.sample(lpFeasibleHalfPlanesModule.defaultParams, {
      step: lpFeasibleHalfPlanesModule.sampleStep ?? BASE_POINT_STEP,
      purpose: 'default',
    });
