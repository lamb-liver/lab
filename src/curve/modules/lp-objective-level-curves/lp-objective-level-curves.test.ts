...
import { lpObjectiveLevelCurvesModule } from './index';

// TODO: 替換佔位幾何後，補上此作品核心數學性質的斷言。
describe('lp-objective-level-curves module', () => {
  it('預設參數採樣非空且落在設計舞台內', () => {
    const out = lpObjectiveLevelCurvesModule.sample(lpObjectiveLevelCurvesModule.defaultParams, {
      step: lpObjectiveLevelCurvesModule.sampleStep ?? BASE_POINT_STEP,
      purpose: 'default',
    });
