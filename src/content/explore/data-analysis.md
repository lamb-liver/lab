...
本頁的重點不是推導每個統計量，而是比較同一筆資料在「整體方向」、「單點影響」、「排序分布」三種讀法下會強調不同訊號。

## 互動說明

- **點雲讀法**：拖動資料點，觀察整體方向與平均位置如何改變
- **影響力讀法**：只移動一個高亮點，對照它是否足以改寫主體趨勢
- **排序讀法**：切到一維資料，觀察同一組數值如何被中位數、四分位與尾端離群切開

建議順序：點雲讀法 → 影響力讀法 → 排序讀法。

## 觀察重點

- 同一批資料在點雲中先呈現方向，在離群對照中呈現影響力，在盒鬚圖中呈現排序後的位置結構。
- 平均與迴歸容易被少數高影響點拉動；中位數與四分位則先問資料排序後中間區間在哪裡。
- 離群不是單一判定，而是讀圖視角：在二維圖上看它拉不拉動趨勢，在一維圖上看它是否落在主要分布尾端之外。
